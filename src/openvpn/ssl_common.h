 ...
 *
 *  @{ */
#define TM_INIT 0 /**< As yet un-trusted \c tls_session being negotiated. */
#define TM_MAIN 1 /**< Active \c tls_session. */
#define TM_LAME 2 /**< Old \c tls_session. */
#define TM_SERV 3
#define TM_BACK 4
#define TM_NOOP 5
#define TM_NULL 6
#define TM_SIZE 7 /**< Size of the \c tls_multi.session array. */
/** @} name Index of tls_session objects within a tls_multi structure */
/** @} addtogroup control_processor */
