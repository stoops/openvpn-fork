...
struct frame
{
    ...
    int bulk_size;         /**< Configured and setup in the init library
                            *   frame function to signal and inform the various other
                            *   related functions to process bulk mode data transfers.
                            *   */
};
