...
/*
    mtio mode commit notes:
      ...
      - briefly track && map connection states to a given thread to ensure packet ordering
      - Use a simple calculation based on the src and dst IP addresses to get a starting list index value
*/
