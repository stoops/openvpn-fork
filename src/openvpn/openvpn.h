...
/*
    mtio mode commit notes:
      ...
      - briefly map connection states to a given next thread to ensure packet ordering
      - Use a simple calculation based on src and dst IP address to get an potential list index value
*/
